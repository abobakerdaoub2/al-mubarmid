...
const projects = [
  { title: 'منظومة الأرشفة الإلكترونية وإدارة الجامعات', category: 'أنظمة أرشفة وشركات', icon: FileText, desc: 'أرشفة إلكترونية شاملة مع صلاحيات دقيقة لدور رئيس القسم.', msg: 'مرحباً المبرمج أرغب في الاستفسار عن منظومة الأرشفة الإلكترونية.' },
  ...
  { title: 'منصة المكتبة الإلكترونية مع تلخيص AI', category: 'ذكاء اصطناعي وكتب', icon: BookOpen, desc: 'مكتبة متطورة مع تلخيص ذكي وميزة الدردشة مع الكتب.', msg: 'مرحباً المبرمج أرغب في الاستفسار عن منصة المكتبة الإلكترونية.' },
